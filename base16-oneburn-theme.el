...
(defun base16-theme-define (theme-name theme-colors)
  ...
  (base16-set-faces
   ...
   '(;; Built in stuff (Emacs 23)
     ...
     (helm-action                                  :foreground base0E)
     (helm-buffer-directory                        :foreground base0D :background nil :weight bold)
     (helm-buffer-file                             :foreground base06) ;; modified
     ...
     (helm-ff-directory                            :foreground base0D :background nil :weight bold) ;; modified
     (helm-ff-executable                           :foreground base0B)
     (helm-ff-file                                 :foreground base06) ;; modified
     (helm-ff-invalid-symlink                      :foreground base0E :background base04)
     (helm-ff-prefix                               :foreground nil :background nil)
     (helm-ff-symlink                              :foreground base0E) ;; modified
...
(deftheme base16-oneburn)

(base16-theme-define 'base16-oneburn base16-oneburn-colors)

(provide-theme 'base16-oneburn)

(provide 'base16-oneburn-theme)
